...
let run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let dom = yield JSDOM.fromURL("https://finance.eastmoney.com/a/ccjdd.html", {
        runScripts: "dangerously", // 启用js脚本能力支持
    ...
    dom.window.onload = function () {
        ...
        let childLi = nowItem === null || nowItem === void 0 ? void 0 : nowItem.getElementsByTagName("li");
        if (childLi) {
